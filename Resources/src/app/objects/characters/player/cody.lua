...
function cody:bbox()
    return self.kinematic_body_:bbox()
end
...
function cody:switch_browner(id)
    ...
    if new_browner.browner_id_ == cc.browners_.violet_.id_ or 
        new_browner.browner_id_ == cc.browners_.teleport_.id_ or 
        new_browner.browner_id_ == cc.browners_.helmet_.id_ then
...
function cody:walk()
    ...
    if self.current_browner_.can_jump_ then
        ...
        if self.current_browner_.browner_id_ ~= cc.browners_.violet_.id_ and
            self.current_browner_.browner_id_ ~= cc.browners_.extreme_.id_ then
                if not self.current_browner_.attacking_ then
...
function cody:exit(args)
    ...
    cc.audio.play_sfx("sounds/sfx_teleport2.mp3", false)
